...
function createElems(param, e) {
    ...
    post += "<div class='feed_title'>";
    
    post += "<img src='images/user.jpg' id='imgpf' class='dropdown-content'>";
    
    post += "<span class='name'>"+name+"</span>";
    
    post += "<div class='menu dropbtn'>";
    post += "<div class='myDropdown'>";
    ...
    if (param == true) {
        post += "<p class='feed_content_image'>" + area.value + "</p>";
    } else if (param == false) {
        post += "<img id='imgpost' src=" + e.target.result + " class='imgpost'>";
    } else {
        post += "<p id='feed_content_image'>" + area.value + "</p>";
        post += "<img id='imgpost' src=" + e.target.result + " class='imgpost'>";
    }
    post += "";
    
    
    var option = "<div class='feed_footer2'>";
    post += option;
    post += "</div>";
    ...
    commentBox += "<div class='commentArea2'></div>";
    commentBox += "</div>";
    post += commentBox;
